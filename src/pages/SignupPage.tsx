        ...
        <div className="min-h-screen bg-black text-white flex items-center justify-center p-6">
            <div className="w-full max-w-md space-y-8">
                ...
                <div className="text-center flex flex-col items-center">
                    ...
                    <p className="text-zinc-500 text-[10px] font-bold uppercase tracking-widest mt-2">Create an account</p>
                </div>
                ...
                <p className="text-center text-[10px] text-zinc-500 uppercase tracking-widest">
                    Already registered? <Link to="/login" className="text-white font-bold hover:text-zinc-200 transition-colors ml-1">Log In</Link>
                </p>
            </div>
        </div>
    );
