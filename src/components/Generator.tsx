    ...
    <div className="w-full max-w-2xl mx-auto space-y-6">
      <div className="bg-zinc-900/40 border border-white/5 rounded-[2.5rem] p-6 backdrop-blur-xl">
        <textarea
          ...
          placeholder="A BANANA EATING A TACO..."
        ...
        <div className="flex items-center justify-between mt-4">
          <div className="flex items-center gap-2 text-zinc-600">
            <Zap size={14} className={isGenerating ? "animate-pulse text-yellow-500" : ""} />
      ...
      {error && (
        <div className="flex items-center justify-center gap-2 text-red-500 font-black text-[10px] tracking-widest uppercase py-4 border border-red-500/20 rounded-2xl bg-red-500/5 animate-pulse">
      ...
      {isGenerating && (
        <div className="space-y-4 py-4">
          ...
          <p className="text-center text-[9px] font-bold tracking-[0.3em] text-zinc-500 uppercase">{currentMessage}</p>
        </div>
      )}
